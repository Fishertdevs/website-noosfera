      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-10 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <img src="/images/hero-main.png" alt="Arte digital principal"
                className="row-span-2 w-full h-full object-cover rounded-2xl"
                style={{ boxShadow: "0 20px 60px rgba(124,58,237,0.18)" }} />
              <img src="/images/hero-top.png" alt="Arte digital 2"
                className="w-full h-full object-cover rounded-2xl"
                style={{ boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }} />
              <img src="/images/hero-bottom.png" alt="Arte digital 3"
                className="w-full h-full object-cover rounded-2xl"
                style={{ boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }} />
            </div>
            ...
            <div
              ...
              style={{ gridTemplateColumns: "2fr 1fr", gridTemplateRows: "1fr 1fr", height: "240px" }}
            >
              <img src="/images/hero-main.png" alt="Arte digital principal"
          ...
          <motion.div
            ...
            className="order-2 lg:order-1 text-center lg:text-left space-y-5"
          >
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-1">
              <button
                onClick={onStartDemo}
                className="px-7 py-3.5 rounded-full font-semibold text-white text-sm tracking-wide transition-all hover:opacity-90 hover:scale-[1.02] active:scale-[0.98]"
              ...
              <button
                onClick={onShowAuth}
                className="px-7 py-3.5 rounded-full font-semibold text-white text-sm tracking-wide transition-all hover:opacity-90 hover:scale-[1.02]"
